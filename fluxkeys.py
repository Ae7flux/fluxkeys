...
[("3D View",
  ...
  {"items":
   [("cbl.convert_between",
    ...
    ("object.invert_weight_value",
     {"type": 'X', "value": 'PRESS'},
     {    "active":False,
      },
     ),
    ("gizmocursor.toggle", {"type": 'MIDDLEMOUSE', "value": 'DOUBLE_CLICK', "ctrl": True, "alt": True}, None),
    ("rtools.callpie",
    ...
    ("three_points_align.check_selection", {"type": 'T', "value": 'PRESS', "alt": True}, None),
    ("wm.call_menu",
    ...
    ("object.f2f_fix_target", {"type": 'F7', "value": 'RELEASE', "ctrl": True}, None),
    ("object.fast_snap_f2f", {"type": 'F7', "value": 'RELEASE', "alt": True}, None),
    ("scene.set_wireframe", {"type": 'W', "value": 'DOUBLE_CLICK'}, None),
    ("scene.set_solid", {"type": 'Q', "value": 'PRESS'}, None),
    ("gizmocursor.align_from_view", {"type": 'MIDDLEMOUSE', "value": 'DOUBLE_CLICK', "shift": True, "ctrl": True}, None),
    ("gizmocursor.to_active", {"type": 'MIDDLEMOUSE', "value": 'DOUBLE_CLICK', "alt": True}, None),
    ("gizmo.reset_cursor_rotation", {"type": 'MIDDLEMOUSE', "value": 'DOUBLE_CLICK', "shift": True, "alt": True}, None),
    ("gizmo.reset_cursor_position", {"type": 'MIDDLEMOUSE', "value": 'DOUBLE_CLICK', "ctrl": True}, None),
    ...
    ("view3d.toggle_orbit_method_jgddr5",
     {"type": 'ACCENT_GRAVE', "value": 'PRESS', "repeat": True},
     {    "active":False,
      },
     ),
    ("object.drag_dupe_translate", {"type": 'LEFTMOUSE', "value": 'PRESS', "shift": True}, None),
    ("wm.context_toggle",
     {"type": 'ZERO', "value": 'PRESS', "shift": True, "ctrl": True, "repeat": True},
     {"properties":
    ...
    ("object.quadriflow_remesh", {"type": 'R', "value": 'PRESS', "shift": True, "alt": True, "repeat": True}, None),
    ("transform.resize",
    ...
    ("scene.set_material", {"type": 'Q', "value": 'DOUBLE_CLICK'}, None),
    ("object.set_pp_active",
     {"type": 'A', "value": 'PRESS'},
     {    "active":False,
      },
     ),
    ("ops.single_scale_op", {"type": 'NUMPAD_9', "value": 'PRESS'}, None),
    ("mesh.zigzag_extrude", {"type": 'NUMPAD_5', "value": 'PRESS', "alt": True}, None),
    ("simpletabs.update", {"type": 'NUMPAD_2', "value": 'PRESS', "ctrl": True}, None),
    ("view3d.flux_test_operator_01", {"type": 'NUMPAD_3', "value": 'PRESS', "ctrl": True}, None),
    ("object.mode_set",
     {"type": 'EVT_TWEAK_R', "value": 'NORTH_WEST'},
     {"properties":
      [("mode", 'OBJECT'),
       ],
      },
    ...
    ("object.mode_set_with_submode",
     {"type": 'EVT_TWEAK_R', "value": 'NORTH_EAST'},
     {"properties":
      [("mode", 'EDIT'),
    ...
    ("object.mode_set_with_submode",
     {"type": 'EVT_TWEAK_R', "value": 'SOUTH_EAST'},
     {"properties":
      [("mode", 'EDIT'),
    ...
    ("object.mode_set",
     {"type": 'EVT_TWEAK_R', "value": 'NORTH_WEST', "shift": True},
     {"properties":
      [("mode", 'SCULPT_GPENCIL'),
       ],
      },
    ...
    ("object.mode_set",
     {"type": 'EVT_TWEAK_R', "value": 'WEST', "shift": True},
     {"properties":
      [("mode", 'SCULPT'),
       ],
      },
    ...
    ("object.mode_set",
     {"type": 'EVT_TWEAK_R', "value": 'SOUTH_WEST', "shift": True},
     {"properties":
      [("mode", 'SCULPT'),
       ],
      },
    ...
    ("three_points_align.check_selection", {"type": 'THREE', "value": 'PRESS', "alt": True}, None),
    ("object.mode_set",
     {"type": 'EVT_TWEAK_R', "value": 'NORTH_WEST'},
     {"properties":
      [("mode", 'SCULPT'),
    ...
    ("object.mode_set",
     {"type": 'EVT_TWEAK_R', "value": 'NORTH_EAST', "shift": True},
     {"properties":
      [("mode", 'TEXTURE_PAINT'),
       ],
      },
    ...
    ("object.mode_set",
     {"type": 'EVT_TWEAK_R', "value": 'EAST', "shift": True},
     {"properties":
      [("mode", 'TEXTURE_PAINT'),
       ],
      },
    ...
    ("object.mode_set",
     {"type": 'EVT_TWEAK_R', "value": 'SOUTH_EAST', "shift": True},
     {"properties":
      [("mode", 'TEXTURE_PAINT'),
       ],
      },
    ...
    ("transform.vert_slide", {"type": 'SEVEN', "value": 'PRESS', "repeat": True}, None),
    ("view3d.select",
    ...
    ("view3d.view_axis",
     {"type": 'F', "value": 'ANY', "shift": True, "ctrl": True, "alt": True},
     {"properties":
      [("type", 'FRONT'),
       ("align_active", False),
       ("relative", True),
    ...
    ("view3d.view_axis",
     {"type": 'T', "value": 'ANY', "key_modifier": 'ACCENT_GRAVE'},
     {"properties":
      [("type", 'TOP'),
       ("relative", True),
       ],
    ...
    ("view3d.view_axis",
     {"type": 'L', "value": 'ANY', "key_modifier": 'ACCENT_GRAVE'},
     {"properties":
      [("type", 'LEFT'),
       ("relative", True),
       ],
    ...
    ("view3d.view_axis",
     {"type": 'R', "value": 'ANY', "key_modifier": 'ACCENT_GRAVE'},
     {"properties":
      [("type", 'RIGHT'),
       ("relative", True),
       ],
    ...
    ("view3d.view_axis",
     {"type": 'K', "value": 'ANY', "key_modifier": 'ACCENT_GRAVE'},
     {"properties":
      [("type", 'BACK'),
       ("relative", True),
       ],
    ...
    ("view3d.view_axis",
     {"type": 'B', "value": 'ANY', "ctrl": True, "repeat": True},
     {"properties":
      [("type", 'BOTTOM'),
       ("align_active", True),
       ],
    ...
    ("view3d.render_border", {"type": 'R', "value": 'PRESS', "shift": True, "ctrl": True}, None),
    ("view3d.clear_render_border", {"type": 'R', "value": 'PRESS', "ctrl": True, "alt": True}, None),
    ("view3d.view_persportho", {"type": 'P', "value": 'PRESS'}, None),
    ("view3d.toggle_xray", {"type": 'X', "value": 'PRESS'}, None),
    ...
    ("view3d.view_camera", {"type": 'C', "value": 'ANY', "shift": True}, None),
    ("view3d.camera_to_view", {"type": 'C', "value": 'PRESS', "alt": True}, None),
    ("view3d.view_axis",
     {"type": 'R', "value": 'ANY'},
     {"properties":
      [("type", 'RIGHT'),
 ...
 ("3D View Tool: Edit Mesh, Angle Tool",
  {"space_type": 'VIEW_3D', "region_type": 'WINDOW'},
  {"items":
   [],
   },
   ...
   [("mesh.polybuild_extrude_at_cursor_move",
     ...
     {"properties":
      [("MESH_OT_polybuild_transform_at_cursor",
        [("use_proportional_projected", True),
         ],
        ),
       ("TRANSFORM_OT_translate",
        [("release_confirm", True),
    ...
    ("mesh.polybuild_face_at_cursor_move",
     {"type": 'MIDDLEMOUSE', "value": 'DOUBLE_CLICK', "ctrl": True},
     {"properties":
      [("TRANSFORM_OT_translate",
        [("release_confirm", True),
         ],
 ...
 ("3D View Tool: Edit Mesh, PolyQuilt",
  {"space_type": 'VIEW_3D', "region_type": 'WINDOW'},
  {"items":
   [("mesh.poly_quilt_brush_size",
     {"type": 'WHEELOUTMOUSE', "value": 'PRESS', "shift": True, "ctrl": True},
     {"properties":
      [("brush_strong_value", 0.05),
       ],
      },
     ),
    ("mesh.poly_quilt_brush_size",
     {"type": 'WHEELINMOUSE', "value": 'PRESS', "shift": True, "ctrl": True},
     {"properties":
      [("brush_strong_value", -0.05),
       ],
      },
    ...
    ("mesh.poly_quilt_brush_size",
     {"type": 'WHEELOUTMOUSE', "value": 'PRESS', "shift": True},
     {"properties":
      [("brush_size_value", -50.0),
       ],
      },
     ),
    ("mesh.poly_quilt_brush_size",
     {"type": 'WHEELINMOUSE', "value": 'PRESS', "shift": True},
     {"properties":
      [("brush_size_value", 50.0),
       ],
      },
     ),
    ("mesh.poly_quilt_key_check", {"type": 'MOUSEMOVE', "value": 'ANY'}, None),
    ("mesh.poly_quilt_hold_lock", {"type": 'LEFT_ALT', "value": 'DOUBLE_CLICK'}, None),
    ("mesh.poly_quilt_brush_size",
     {"type": 'WHEELOUTMOUSE', "value": 'PRESS', "shift": True, "ctrl": True},
     {"properties":
      [("brush_strong_value", 0.05),
 ...
 ("3D View Tool: Edit Mesh, Zen Sets Tool",
  {"space_type": 'VIEW_3D', "region_type": 'WINDOW'},
  {"items":
   [("view3d.select_box",
 ...
 ("3D View Tool: Move",
  {"space_type": 'VIEW_3D', "region_type": 'WINDOW'},
  {"items":
   [("view3d.select_lasso", {"type": 'EVT_TWEAK_L', "value": 'WEST'}, None),
    ("view3d.select_lasso",
     {"type": 'EVT_TWEAK_L', "value": 'SOUTH_WEST', "ctrl": True},
     {"properties":
      [("mode", 'ADD'),
       ],
      },
    ...
    ("view3d.select_circle", {"type": 'EVT_TWEAK_L', "value": 'SOUTH'}, None),
    ("view3d.select_circle",
     {"type": 'EVT_TWEAK_L', "value": 'SOUTH', "ctrl": True},
     {"properties":
      [("mode", 'ADD'),
       ],
      },
    ...
    ("view3d.select_circle",
     {"type": 'EVT_TWEAK_L', "value": 'SOUTH', "alt": True},
     {"properties":
      [("mode", 'SUB'),
       ],
      },
    ...
    ("view3d.select_lasso",
     {"type": 'EVT_TWEAK_L', "value": 'NORTH_WEST', "ctrl": True},
     {"properties":
      [("mode", 'ADD'),
       ],
      },
    ...
    ("view3d.select_lasso",
     {"type": 'EVT_TWEAK_L', "value": 'WEST', "ctrl": True},
     {"properties":
      [("mode", 'ADD'),
       ],
      },
    ...
    ("view3d.select_lasso",
     {"type": 'EVT_TWEAK_L', "value": 'WEST', "alt": True},
     {"properties":
      [("mode", 'SUB'),
       ],
      },
    ...
    ("view3d.select_lasso",
     {"type": 'EVT_TWEAK_L', "value": 'NORTH_WEST', "alt": True},
     {"properties":
      [("mode", 'SUB'),
       ],
      },
    ...
    ("view3d.select_lasso", {"type": 'EVT_TWEAK_L', "value": 'NORTH_WEST'}, None),
    ("view3d.select_lasso", {"type": 'EVT_TWEAK_L', "value": 'SOUTH_WEST'}, None),
    ("view3d.select_lasso", {"type": 'EVT_TWEAK_L', "value": 'SOUTH_WEST', "alt": True}, None),
    ("view3d.select_box",
    ...
    ("view3d.select_lasso",
     {"type": 'EVT_TWEAK_L', "value": 'SOUTH_WEST', "alt": True},
     {"properties":
      [("mode", 'SUB'),
       ],
      },
 ...
 ("3D View Tool: Object, Flexi Draw Bezier",
  {"space_type": 'VIEW_3D', "region_type": 'WINDOW'},
  {"items":
   [("wm.flexi_draw_bezier_curves", {"type": 'MOUSEMOVE', "value": 'ANY'}, None),
    ("wm.flexi_draw_bezier_curves", {"type": 'MOUSEMOVE', "value": 'ANY'}, None),
    ("wm.flexi_draw_grease_bezier_curves", {"type": 'LEFTMOUSE', "value": 'PRESS', "shift": True, "ctrl": True}, None),
    ],
   },
  ),
 ("3D View Tool: Object, Flexi Edit Bezier",
  {"space_type": 'VIEW_3D', "region_type": 'WINDOW'},
  {"items":
   [("wm.modal_flexi_edit_bezier", {"type": 'MOUSEMOVE', "value": 'ANY'}, None),
    ("wm.modal_flexi_edit_bezier",
 ...
 ("3D View Tool: Object, Flexi Grease Draw Bezier",
  {"space_type": 'VIEW_3D', "region_type": 'WINDOW'},
  {"items":
   [("wm.flexi_draw_grease_bezier_curves", {"type": 'MOUSEMOVE', "value": 'ANY'}, None),
    ("wm.flexi_draw_grease_bezier_curves", {"type": 'MOUSEMOVE', "value": 'ANY', "shift": True, "ctrl": True}, None),
    ("wm.flexi_draw_grease_bezier_curves", {"type": 'MOUSEMOVE', "value": 'ANY'}, None),
    ],
   },
  ),
 ...
 ("3D View Tool: Rotate",
  ...
  {"items":
   [("view3d.select_lasso", {"type": 'EVT_TWEAK_L', "value": 'WEST'}, None),
    ...
    ("view3d.select_box", {"type": 'EVT_TWEAK_L', "value": 'NORTH_EAST'}, None),
    ("view3d.select_box", {"type": 'EVT_TWEAK_L', "value": 'SOUTH_EAST'}, None),
    ("view3d.select_box",
     {"type": 'EVT_TWEAK_L', "value": 'EAST'},
     {"properties":
      [("mode", 'SET'),
    ...
    ("view3d.select_lasso", {"type": 'EVT_TWEAK_L', "value": 'SOUTH_WEST', "ctrl": True}, None),
    ("view3d.select_box",
     {"type": 'EVT_TWEAK_L', "value": 'EAST', "alt": True},
     {"properties":
      [("mode", 'SUB'),
    ...
    ("view3d.select_box", {"type": 'EVT_TWEAK_L', "value": 'WEST'}, None),
    ],
   },
  ),
 ("3D View Tool: Scale",
  ...
  {"items":
   [("view3d.select_lasso", {"type": 'EVT_TWEAK_L', "value": 'WEST'}, None),
    ...
    ("view3d.select_box", {"type": 'EVT_TWEAK_L', "value": 'EAST'}, None),
    ("view3d.select_box", {"type": 'EVT_TWEAK_L', "value": 'NORTH_EAST'}, None),
    ("view3d.select_box", {"type": 'EVT_TWEAK_L', "value": 'SOUTH_EAST'}, None),
    ("view3d.select_box",
     {"type": 'EVT_TWEAK_L', "value": 'EAST', "ctrl": True},
 ...
 ("3D View Tool: Transform",
  ...
  {"items":
   [("view3d.select_lasso",
    ...
    ("view3d.select_lasso", {"type": 'EVT_TWEAK_L', "value": 'EAST'}, None),
    ],
   },
  ),
 ("3D View Tool: Tweak",
 ...
 ("Bevel Modal Map",
  ...
  {"items":
   [("CANCEL", {"type": 'ESC', "value": 'PRESS', "any": True, "repeat": True}, None),
    ...
    ("CLAMP_OVERLAP_TOGGLE", {"type": 'C', "value": 'PRESS', "alt": True, "repeat": True}, None),
    ...
    ("", {"type": 'Z', "value": 'PRESS', "any": True, "repeat": True}, None),
 ...
 ("Clip Editor",
  ...
  {"items":
   [("wm.search_menu", {"type": 'TAB', "value": 'PRESS', "repeat": True}, None),
    ...
    ("clip.keyframe_insert", {"type": 'S', "value": 'PRESS', "ctrl": True, "alt": True, "repeat": True}, None),
 ...
 ("Curve",
  ...
  {"items":
   [("cbl.cut_cable",
    ...
    ("curve.select_linked", {"type": 'ONE', "value": 'PRESS', "repeat": True}, None),
    ("curve.duplicate_move", {"type": 'D', "value": 'PRESS', "repeat": True}, None),
    ("wm.call_menu",
     {"type": 'BACK_SPACE', "value": 'PRESS', "repeat": True},
     {"properties":
    ...
    ("curve.select_next", {"type": 'RIGHT_ARROW', "value": 'PRESS', "repeat": True}, None),
    ("curve.select_previous", {"type": 'LEFT_ARROW', "value": 'PRESS', "repeat": True}, None),
    ("curve.split", {"type": 'J', "value": 'PRESS', "shift": True, "repeat": True}, None),
    ("curve.separate", {"type": 'J', "value": 'PRESS', "alt": True, "repeat": True}, None),
    ("wm.tool_set_by_id",
    ...
    ("curve.vertex_add", {"type": 'LEFTMOUSE', "value": 'PRESS', "shift": True}, None),
    ("curve.extrude_move", {"type": 'E', "value": 'PRESS', "repeat": True}, None),
    ("curve.subdivide", {"type": 'S', "value": 'PRESS', "repeat": True}, None),
    ...
    ("wm.tool_set_by_id",
     {"type": 'NUMPAD_7', "value": 'PRESS', "alt": True, "repeat": True},
     {"properties":
      [("name", 'builtin.scale'),
       ],
      },
    ...
    ("object.mode_set", {"type": 'EVT_TWEAK_R', "value": 'SOUTH_WEST'}, None),
    ("curve.handle_type_set",
    ...
    ("curve.remove_double", {"type": 'A', "value": 'PRESS', "repeat": True}, None),
    ("curve.handle_type_set",
 ...
 ("Custom Normals Modal Map",
  ...
  {"items":
   [("CANCEL", {"type": 'ESC', "value": 'PRESS', "any": True, "repeat": True}, None),
    ...
    ("USE_PIVOT", {"type": 'L', "value": 'PRESS', "key_modifier": 'ACCENT_GRAVE', "repeat": True}, None),
 ...
 ("Generic Gizmo Maybe Drag",
  {"space_type": 'EMPTY', "region_type": 'WINDOW'},
  {"items":
   [("gizmo.3d_cursor_add", {"type": 'LEFTMOUSE', "value": 'PRESS'}, None),
    ],
   },
  ),
 ...
 ("Generic Gizmo Tweak Modal Map",
  ...
  {"items":
   [("CANCEL", {"type": 'ESC', "value": 'PRESS', "any": True, "repeat": True}, None),
    ...
    ("CONFIRM", {"type": 'NUMPAD_ENTER', "value": 'PRESS', "any": True, "repeat": True}, None),
    ("PRECISION_ON",
     {"type": 'RIGHT_SHIFT', "value": 'PRESS', "any": True, "repeat": True},
     {    "active":False,
      },
     ),
    ("PRECISION_OFF",
    ...
    ("PRECISION_ON",
     {"type": 'LEFT_SHIFT', "value": 'PRESS', "repeat": True},
     {    "active":False,
      },
     ),
    ("PRECISION_OFF",
    ...
    ("SNAP_ON", {"type": 'LEFT_CTRL', "value": 'PRESS', "repeat": True}, None),
    ("SNAP_OFF", {"type": 'LEFT_CTRL', "value": 'RELEASE'}, None),
    ],
   },
  ),
 ...
 ("Graph Editor",
  ...
  {"items":
   [("wm.search_menu", {"type": 'TAB', "value": 'PRESS', "repeat": True}, None),
    ...
    ("graph.keyframe_insert", {"type": 'S', "value": 'PRESS', "ctrl": True, "alt": True, "repeat": True}, None),
 ...
 ("Image",
  ...
  {"items":
   [("object.vertscale_yuv", {"type": 'X', "value": 'PRESS', "ctrl": True, "alt": True}, None),
    ("object.vertscale_xuv", {"type": 'Y', "value": 'PRESS', "ctrl": True, "alt": True}, None),
    ("image.view_all", {"type": 'Z', "value": 'PRESS'}, None),
    ("image.view_selected", {"type": 'F', "value": 'PRESS', "repeat": True}, None),
    ("image.view_pan", {"type": 'MIDDLEMOUSE', "value": 'CLICK_DRAG'}, None),
    ...
    ("object.vertscale_zuv", {"type": 'Z', "value": 'PRESS', "ctrl": True}, None),
    ],
   },
  ),
 ...
 ("Image Editor Tool: Uv, Cursor",
  {"space_type": 'IMAGE_EDITOR', "region_type": 'WINDOW'},
  {"items":
   [("uv.cursor_set", {"type": 'MIDDLEMOUSE', "value": 'DOUBLE_CLICK'}, None),
    ],
   },
  ),
 ("Image Editor Tool: Uv, Move",
  ...
  {"items":
   [("transform.translate",
    ...
    ("uv.select_box", {"type": 'EVT_TWEAK_L', "value": 'EAST'}, None),
    ("uv.select_circle",
     {"type": 'EVT_TWEAK_L', "value": 'SOUTH'},
     {"properties":
      [("mode", 'SET'),
 ...
 ("Image Generic",
  ...
  {"items":
   [("wm.call_panel",
    ...
    ("image.save", {"type": 'S', "value": 'PRESS', "ctrl": True, "repeat": True}, None),
 ...
 ("Image Paint",
  ...
  {"items":
   [("wm.call_menu",
    ...
    ("paint.grab_clone", {"type": 'MIDDLEMOUSE', "value": 'PRESS', "shift": True}, None),
    ("brush.scale_size",
     {"type": 'LEFT_BRACKET', "value": 'PRESS', "repeat": True},
     {"properties":
      [("scalar", 0.9),
    ...
    ("paint.multipaint", {"type": 'LEFTMOUSE', "value": 'PRESS', "shift": True, "alt": True}, None),
    ("brush.stencil_control",
     {"type": 'MIDDLEMOUSE', "value": 'PRESS', "shift": True, "key_modifier": 'ACCENT_GRAVE'},
     {"properties":
      [("mode", 'SCALE'),
       ("texmode", 'SECONDARY'),
       ],
    ...
    ("brush.stencil_control",
     {"type": 'MIDDLEMOUSE', "value": 'PRESS', "ctrl": True, "key_modifier": 'ACCENT_GRAVE'},
     {"properties":
      [("mode", 'ROTATION'),
       ("texmode", 'SECONDARY'),
       ],
 ...
 ("Mesh",
  ...
  {"items":
   [("mesh.smart_fill_repeat",
    ...
    ("zsts.smart_select", {"type": 'F2', "value": 'PRESS', "alt": True}, None),
    ("mesh.smart_fill_repeat",
     {"type": 'WHEELUPMOUSE', "value": 'PRESS', "ctrl": True},
     {"properties":
      [("delta", 1),
    ...
    ("zsts.smart_select", {"type": 'F2', "value": 'PRESS', "alt": True}, None),
    ("mesh.f2", {"type": 'LEFTMOUSE', "value": 'PRESS', "key_modifier": 'ACCENT_GRAVE'}, None),
    ...
    ("zsts.new_group", {"type": 'F1', "value": 'PRESS', "alt": True}, None),
    ("zenuv.call_popup", {"type": 'U', "value": 'PRESS', "shift": True}, None),
    ("zenuv.call_pie", {"type": 'U', "value": 'PRESS', "alt": True}, None),
    ("zsts.draw_highlight", {"type": 'F5', "value": 'PRESS', "alt": True}, None),
    ("zsts.group_siblings", {"type": 'F2', "value": 'PRESS', "alt": True}, None),
    ("mesh.select_all",
     {"type": 'I', "value": 'PRESS', "repeat": True},
     {"properties":
      [("action", 'INVERT'),
    ...
    ("mesh.duplicate_move", {"type": 'D', "value": 'PRESS', "repeat": True}, None),
    ("wm.call_menu",
     {"type": 'APP', "value": 'PRESS', "repeat": True},
     {"properties":
    ...
    ("mesh.remove_doubles", {"type": 'A', "value": 'PRESS', "repeat": True}, None),
    ("mesh.extrude_edges_move", {"type": 'E', "value": 'PRESS', "repeat": True}, None),
    ("mesh.separate",
    ...
    ("mesh.fill", {"type": 'F', "value": 'PRESS', "ctrl": True, "repeat": True}, None),
    ("mesh.mark_seam",
     {"type": 'M', "value": 'PRESS', "repeat": True},
     {"properties":
      [("clear", False),
    ...
    ("mesh.flip_normals", {"type": 'N', "value": 'PRESS', "ctrl": True, "repeat": True}, None),
    ("mesh.fill_grid", {"type": 'F', "value": 'PRESS', "alt": True, "repeat": True}, None),
    ("mesh.subdivide",
     {"type": 'S', "value": 'PRESS', "repeat": True},
     {"properties":
    ...
    ("mesh.fill_holes", {"type": 'FIVE', "value": 'PRESS', "repeat": True}, None),
    ("wm.call_menu",
     {"type": 'RIGHTMOUSE', "value": 'CLICK'},
     {"properties":
      [("name", 'VIEW3D_MT_edit_mesh_context_menu'),
    ...
    ("mesh.split", {"type": 'J', "value": 'PRESS', "shift": True, "repeat": True}, None),
    ...
    ("wm.call_menu",
     {"type": 'NUMPAD_ASTERIX', "value": 'CLICK_DRAG'},
     {"properties":
      [("name", 'VIEW3D_MT_'),
       ],
      },
    ...
    ("mesh.region_to_loop", {"type": 'L', "value": 'PRESS', "shift": True, "repeat": True}, None),
    ("object.edge_to_curve", {"type": 'E', "value": 'PRESS', "alt": True}, None),
    ("mesh.looptools_flatten", {"type": 'F', "value": 'PRESS', "shift": True, "repeat": True}, None),
    ("wm.tool_set_by_id",
     {"type": 'NUMPAD_1', "value": 'PRESS', "repeat": True},
     {"properties":
      [("name", 'builtin.scale'),
    ...
    ("object.set_snap_target_active", {"type": 'NUMPAD_MINUS', "value": 'PRESS', "alt": True}, None),
    ("mesh.loop_to_region", {"type": 'L', "value": 'PRESS', "alt": True, "repeat": True}, None),
    ("mesh.set_normals_from_faces", {"type": 'N', "value": 'PRESS', "shift": True, "repeat": True}, None),
    ...
    ("mesh.delete", {"type": 'MIDDLEMOUSE', "value": 'CLICK', "shift": True}, None),
    ("mesh.loop_multi_select",
    ...
    ("mesh.select_linked", {"type": 'ONE', "value": 'PRESS', "repeat": True}, None),
    ],
   },
  ),
 ("Metaball",
 ...
 ("Node Editor",
  ...
  {"items":
   [("node.sv_abort_nodes_updating", {"type": 'ESC', "value": 'PRESS', "alt": True}, None),
    ("node.nw_add_textures_for_principled", {"type": 'T', "value": 'PRESS', "shift": True, "alt": True}, None),
    ...
    ("node.sv_abort_nodes_updating", {"type": 'ESC', "value": 'PRESS', "shift": True}, None),
    ...
    ("rtools.callnodemixmenu", {"type": 'M', "value": 'PRESS', "alt": True}, None),
    ...
    ("node.enter_exit_group_nodes", {"type": 'NUMPAD_SLASH', "value": 'PRESS'}, None),
    ("noodler.favorite_add", {"type": 'Y', "value": 'PRESS', "ctrl": True}, None),
    ("noodler.chamfer", {"type": 'B', "value": 'PRESS'}, None),
    ...
    ("node.nw_merge_nodes", {"type": 'M', "value": 'PRESS', "ctrl": True}, None),
    ("node.nw_copy_label", {"type": 'V', "value": 'PRESS', "shift": True}, None),
    ("node.nw_merge_nodes", {"type": 'ZERO', "value": 'PRESS', "ctrl": True}, None),
    ("node.backimage_fit", {"type": 'A', "value": 'PRESS', "shift": True, "repeat": True}, None),
    ("object.drag_dupe_node", {"type": 'LEFTMOUSE', "value": 'PRESS', "shift": True}, None),
    ("node.join", {"type": 'J', "value": 'PRESS', "repeat": True}, None),
    ...
    ("node.hide_socket_toggle", {"type": 'H', "value": 'PRESS', "alt": True, "repeat": True}, None),
    ("node.view_all", {"type": 'NDOF_BUTTON_FIT', "value": 'PRESS'}, None),
    ("node.view_selected", {"type": 'Z', "value": 'PRESS', "shift": True, "repeat": True}, None),
    ...
    ("node.group_ungroup", {"type": 'G', "value": 'PRESS', "alt": True, "repeat": True}, None),
    ("node.clipboard_paste", {"type": 'V', "value": 'PRESS', "ctrl": True, "repeat": True}, None),
    ("node.viewer_border", {"type": 'Z', "value": 'PRESS', "shift": True, "ctrl": True, "repeat": True}, None),
    ("node.clear_viewer_border", {"type": 'Z', "value": 'PRESS', "shift": True, "alt": True, "repeat": True}, None),
    ("transform.resize", {"type": 'R', "value": 'PRESS', "repeat": True}, None),
    ...
    ("node.link", {"type": 'EVT_TWEAK_L', "value": 'ANY', "ctrl": True}, None),
    ("node.link",
     {"type": 'LEFTMOUSE', "value": 'PRESS'},
     {"properties":
      [("detach", True),
    ...
    ("node.delete", {"type": 'MIDDLEMOUSE', "value": 'PRESS', "shift": True}, None),
    ("node.select_lasso",
     {"type": 'EVT_TWEAK_R', "value": 'NORTH_WEST'},
     {"properties":
      [("tweak", True),
    ...
    ("node.delete_reconnect", {"type": 'MIDDLEMOUSE', "value": 'PRESS', "shift": True, "ctrl": True}, None),
    ("node.resize", {"type": 'EVT_TWEAK_L', "value": 'ANY'}, None),
    ("node.nw_align_nodes", {"type": 'A', "value": 'PRESS', "shift": True}, None),
    ("node.add_reroute", {"type": 'EVT_TWEAK_R', "value": 'ANY', "shift": True}, None),
    ("node.move_detach_links", {"type": 'EVT_TWEAK_L', "value": 'ANY', "shift": True, "alt": True}, None),
    ...
    ("object.drag_dupe_nodei", {"type": 'LEFTMOUSE', "value": 'PRESS', "alt": True}, None),
    ("node.detach", {"type": 'J', "value": 'PRESS', "alt": True, "repeat": True}, None),
    ("noodler.draw_frame", {"type": 'F', "value": 'CLICK_DRAG', "shift": True, "ctrl": True}, None),
    ("noodler.dependency_select", {"type": 'LEFT_ARROW', "value": 'PRESS'}, None),
    ...
    ("node.tree_path_parent", {"type": 'TAB', "value": 'PRESS', "repeat": True}, None),
    ],
   },
  ),
 ("Node Generic",
  ...
  {"items":
   [("wm.call_panel",
    ...
    ("object.drag_dupe_nodei", {"type": 'LEFTMOUSE', "value": 'PRESS', "shift": True, "ctrl": True}, None),
    ("node.nw_modify_labels", {"type": 'L', "value": 'PRESS'}, None),
    ],
   },
  ),
 ("Node Tool: Links Cut",
 ...
 ("Object Mode",
  ...
  {"items":
   [("wm.call_menu",
    ...
    ("object.booltool_auto_difference", {"type": 'D', "value": 'PRESS', "ctrl": True, "repeat": True}, None),
    ("object.booltool_auto_union", {"type": 'U', "value": 'PRESS', "ctrl": True, "repeat": True}, None),
    ...
    ("object.HIDE", {"type": 'H', "value": 'PRESS'}, None),
    ("view3d.select",
     {"type": 'LEFTMOUSE', "value": 'CLICK_DRAG'},
     {"properties":
      [("enumerate", False),
 ...
 ("Outliner",
  ...
  {"items":
   [("outliner.item_rename", {"type": 'LEFTMOUSE', "value": 'DOUBLE_CLICK'}, None),
    ...
    ("outliner.show_active", {"type": 'SPACE', "value": 'PRESS', "repeat": True}, None),
    ...
    ("outliner.collection_delete", {"type": 'DEL', "value": 'PRESS', "shift": True, "repeat": True}, None),
    ...
    ("outliner.id_copy", {"type": 'WHEELDOWNMOUSE', "value": 'PRESS'}, None),
    ("outliner.id_paste", {"type": 'V', "value": 'PRESS', "ctrl": True, "repeat": True}, None),
    ("outliner.item_openclose", {"type": 'LEFTMOUSE', "value": 'PRESS'}, None),
    ],
   },
  ),
 ("Paint Curve",
 ...
 ("Screen",
  ...
  {"items":
   [("screen.repeat_last", {"type": 'G', "value": 'PRESS', "repeat": True}, None),
    ...
    ("screen.space_context_cycle",
     {"type": 'NUMPAD_5', "value": 'CLICK', "shift": True, "ctrl": True, "alt": True},
     {"properties":
      [("direction", 'NEXT'),
       ],
      },
    ...
    ("ed.undo_history", {"type": 'RIGHTMOUSE', "value": 'CLICK', "shift": True}, None),
    ("render.view_cancel", {"type": 'ESC', "value": 'PRESS', "repeat": True}, None),
    ("ed.undo", {"type": 'RIGHTMOUSE', "value": 'CLICK', "ctrl": True}, None),
    ("screen.region_flip", {"type": 'NONE', "value": 'PRESS', "repeat": True}, None),
    ("ed.redo", {"type": 'RIGHTMOUSE', "value": 'PRESS', "alt": True}, None),
  ...
  {"items":
   [("wm.pmi_data_edit",
    ...
    ("screen.screen_full_area",
     {"type": 'SPACE', "value": 'ANY', "ctrl": True},
     {"properties":
    ...
    ("screen.actionzone", {"type": 'LEFTMOUSE', "value": 'PRESS'}, None),
    ("screen.area_split",
     {"type": 'LEFTMOUSE', "value": 'PRESS', "shift": True, "ctrl": True, "alt": True},
     {"properties":
      [("direction", 'VERTICAL'),
 ...
 ("Sculpt",
  ...
  {"items":
   [("sculpt.brush_stroke",
    ...
    ("object.set_brush_direction", {"type": 'MIDDLEMOUSE', "value": 'DOUBLE_CLICK'}, None),
    ("wm.call_menu",
 ...
 ("Sequence Editor Tool: Sequencer, Trim",
 ...
 ("Sequencer",
  ...
  {"items":
   [("sequencer.refresh_all", {"type": 'R', "value": 'PRESS', "shift": True}, None),
    ...
    ("power_sequencer.space_sequences", {"type": 'EQUAL', "value": 'PRESS'}, None),
    ("power_sequencer.playback_speed_increase", {"type": 'PERIOD', "value": 'PRESS'}, None),
    ("power_sequencer.space_sequences", {"type": 'EQUAL', "value": 'PRESS', "repeat": True}, None),
    ("power_sequencer.playback_speed_increase", {"type": 'PERIOD', "value": 'PRESS', "repeat": True}, None),
    ("power_sequencer.space_sequences", {"type": 'EQUAL', "value": 'PRESS', "repeat": True}, None),
    ("power_sequencer.playback_speed_increase", {"type": 'PERIOD', "value": 'PRESS', "repeat": True}, None),
    ("power_sequencer.space_sequences", {"type": 'EQUAL', "value": 'PRESS', "repeat": True}, None),
    ("power_sequencer.playback_speed_increase", {"type": 'PERIOD', "value": 'PRESS', "repeat": True}, None),
 ...
 ("Toolbar Popup <temp>",
  ...
  {"items":
   [("wm.tool_set_by_id",
    ...
    ("wm.tool_set_by_id",
     {"type": 'FOUR', "value": 'PRESS', "shift": True, "repeat": True},
     {"properties":
      [("name", 'builtin.bisect'),
       ],
      },
    ...
    ("wm.tool_set_by_id",
     {"type": 'FIVE', "value": 'PRESS', "shift": True, "repeat": True},
     {"properties":
    ...
    ("wm.tool_set_by_id",
     {"type": 'NUMPAD_5', "value": 'PRESS', "shift": True, "repeat": True},
     {"properties":
      [("name", 'builtin.poly_build'),
       ],
      },
    ...
    ("wm.tool_set_by_id",
     {"type": 'SIX', "value": 'PRESS', "shift": True, "repeat": True},
     {"properties":
      [("name", 'mesh_tool.poly_quilt'),
       ],
      },
     ),
    ("wm.tool_set_by_id",
    ...
    ("wm.tool_set_by_id",
     {"type": 'SEVEN', "value": 'PRESS', "shift": True, "repeat": True},
     {"properties":
      [("name", 'builtin.spin'),
       ],
      },
    ...
    ("wm.tool_set_by_id",
     {"type": 'EIGHT', "value": 'PRESS', "shift": True, "repeat": True},
     {"properties":
    ...
    ("wm.tool_set_by_id",
     {"type": 'NINE', "value": 'PRESS', "shift": True, "repeat": True},
     {"properties":
      [("name", 'builtin.smooth'),
       ],
      },
    ...
    ("wm.tool_set_by_id",
     {"type": 'NUMPAD_9', "value": 'PRESS', "shift": True, "repeat": True},
     {"properties":
      [("name", 'builtin.smooth'),
       ],
      },
    ...
    ("wm.tool_set_by_id",
     {"type": 'ZERO', "value": 'PRESS', "shift": True, "repeat": True},
     {"properties":
 ...
 ("Transform Modal Map",
  ...
  {"items":
   [("CONFIRM", {"type": 'LEFTMOUSE', "value": 'PRESS', "any": True}, None),
    ...
    ("RESIZE", {"type": 'S', "value": 'PRESS', "ctrl": True, "alt": True, "repeat": True}, None),
 ...
 ("UV Editor",
  ...
  {"items":
   [("wm.call_panel",
    ...
    ("uv.weld", {"type": 'W', "value": 'PRESS', "repeat": True}, None),
    ("uv.select",
     {"type": 'LEFTMOUSE', "value": 'PRESS', "alt": True},
     {    "active":False,
      },
     ),
    ("uv.remove_doubles", {"type": 'D', "value": 'PRESS', "repeat": True}, None),
    ("uv.cursor_set", {"type": 'MIDDLEMOUSE', "value": 'DOUBLE_CLICK'}, None),
    ("uv.unwrap", {"type": 'U', "value": 'PRESS', "repeat": True}, None),
    ("uv.select_lasso",
     {"type": 'EVT_TWEAK_R', "value": 'NORTH_WEST'},
    ...
    ("uv.select_lasso", {"type": 'EVT_TWEAK_R', "value": 'WEST'}, None),
    ("uv.select_lasso", {"type": 'EVT_TWEAK_R', "value": 'SOUTH_WEST'}, None),
    ("uv.select_lasso",
     {"type": 'EVT_TWEAK_R', "value": 'NORTH_WEST', "ctrl": True},
     {"properties":
      [("mode", 'ADD'),
       ],
      },
    ...
    ("uv.select_lasso",
     {"type": 'EVT_TWEAK_R', "value": 'WEST', "ctrl": True},
     {"properties":
      [("mode", 'ADD'),
       ],
      },
    ...
    ("uv.select_lasso",
     {"type": 'EVT_TWEAK_R', "value": 'SOUTH_WEST', "ctrl": True},
     {"properties":
      [("mode", 'ADD'),
       ],
      },
    ...
    ("uv.select_lasso",
     {"type": 'EVT_TWEAK_R', "value": 'NORTH_WEST', "alt": True},
     {"properties":
      [("mode", 'SUB'),
       ],
      },
    ...
    ("uv.select_lasso",
     {"type": 'EVT_TWEAK_R', "value": 'WEST', "alt": True},
     {"properties":
      [("mode", 'SUB'),
       ],
      },
    ...
    ("uv.select_lasso",
     {"type": 'EVT_TWEAK_R', "value": 'SOUTH_WEST', "alt": True},
     {"properties":
      [("mode", 'SUB'),
       ],
      },
    ...
    ("uv.select_box",
     {"type": 'EVT_TWEAK_R', "value": 'NORTH_EAST', "ctrl": True},
     {"properties":
      [("mode", 'ADD'),
       ],
      },
    ...
    ("uv.select_box",
     {"type": 'EVT_TWEAK_R', "value": 'EAST', "ctrl": True},
     {"properties":
      [("mode", 'ADD'),
       ],
      },
    ...
    ("uv.select_box",
     {"type": 'EVT_TWEAK_R', "value": 'SOUTH_EAST', "ctrl": True},
     {"properties":
      [("mode", 'ADD'),
       ],
      },
    ...
    ("uv.select_box",
     {"type": 'EVT_TWEAK_R', "value": 'NORTH_EAST', "alt": True},
     {"properties":
      [("mode", 'SUB'),
       ],
      },
    ...
    ("uv.select_box",
     {"type": 'EVT_TWEAK_R', "value": 'SOUTH_EAST', "alt": True},
     {"properties":
      [("mode", 'SUB'),
       ],
      },
    ...
    ("uv.select_circle",
     {"type": 'EVT_TWEAK_R', "value": 'SOUTH', "ctrl": True},
     {"properties":
      [("mode", 'ADD'),
       ],
      },
    ...
    ("uv.select_circle",
     {"type": 'EVT_TWEAK_R', "value": 'SOUTH', "alt": True},
     {"properties":
      [("mode", 'SUB'),
       ],
      },
 ...
 ("User Interface",
  {"space_type": 'EMPTY', "region_type": 'WINDOW'},
  {"items":
   [("ui.eyedropper_color", {"type": 'I', "value": 'PRESS', "alt": True, "repeat": True}, None),
    ...
    ("anim.driver_button_add", {"type": 'D', "value": 'PRESS', "shift": True, "ctrl": True, "alt": True, "repeat": True}, None),
    ...
    ("ui.eyedropper_depth", {"type": 'E', "value": 'PRESS', "ctrl": True, "alt": True, "repeat": True}, None),
    ],
   },
  ),
 ("Vertex Paint",
 ...
 ("View2D",
  ...
  {"items":
   [("view2d.scroller_activate", {"type": 'LEFTMOUSE', "value": 'PRESS'}, None),
    ...
    ("wm.context_toggle_enum",
     {"type": 'LEFT_SHIFT', "value": 'PRESS', "shift": True, "ctrl": True},
     {"properties":
 ...
 ("View2D Buttons List",
  ...
  {"items":
   [("view2d.scroller_activate", {"type": 'LEFTMOUSE', "value": 'PRESS'}, None),
    ...
    ("view2d.zoom", {"type": 'WHEELDOWNMOUSE', "value": 'PRESS'}, None),
 ...
 ("View3D Rotate Modal",
  {"space_type": 'EMPTY', "region_type": 'WINDOW', "modal": True},
  {"items":
   [("CONFIRM", {"type": 'MIDDLEMOUSE', "value": 'RELEASE', "ctrl": True}, None),
    ("CONFIRM", {"type": 'ESC', "value": 'PRESS', "any": True, "repeat": True}, None),
 ...
 ("View3D Walk Modal",
  ...
  {"items":
   [("CANCEL", {"type": 'RIGHTMOUSE', "value": 'ANY', "any": True}, None),
    ...
    ("BACKWARD", {"type": 'S', "value": 'PRESS', "oskey": -1, "repeat": True}, None),
    ...
    ("BACKWARD_STOP", {"type": 'S', "value": 'RELEASE', "alt": True, "oskey": -1}, None),
 ...
 ("View3D Zoom Modal",
  ...
  {"items":
   [("CONFIRM",
     {"type": 'WHEELUPMOUSE', "value": 'RELEASE'},
     {    "active":False,
      },
     ),
    ("CONFIRM",
  ...
  {"items":
   [("wm.call_menu_pie",
    ...
    ("wm.context_toggle",
     ...
     {"properties":
      [("data_path", 'space_data.overlay.show_bones'),
       ],
      },
     ),
    ("wm.context_menu_enum",
    ...
    ("wm.context_toggle",
     {"type": 'NUMPAD_5', "value": 'PRESS', "repeat": True},
     {"properties":
      [("data_path", 'space_data.show_gizmo_object_scale'),
       ],
      },
     ),
    ("wm.context_menu_enum",
    ...
    ("wm.tool_set_by_id",
     {"type": 'NUMPAD_5', "value": 'PRESS', "shift": True, "ctrl": True, "repeat": True},
     {"properties":
      [("name", 'builtin.select_box'),
       ],
      },
    ...
    ("wm.context_toggle",
     {"type": 'ZERO', "value": 'PRESS', "shift": True, "repeat": True},
     {"properties":
      [("data_path", 'space_data.overlay.show_vertex_normals'),
       ],
      },
     ),
    ("wm.context_toggle",
     {"type": 'ZERO', "value": 'PRESS', "ctrl": True, "repeat": True},
     {"properties":
      [("data_path", 'space_data.overlay.show_split_normals'),
       ],
      },
     ),
    ("wm.context_toggle",
